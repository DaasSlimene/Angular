...
export class BookService {
  ...
  url='http://localhost:8080/ProjetVermegSpringMVC/api/book';
  constructor(private http : HttpClient) { 
   

  }
  getAllBooks(){
    return this.http.get("http://localhost:8080/ProjetVermegSpringMVC/api/book/getAll");
...
updateBook( id: any,  author:string,  price:number,releasedate:Date, title:string){
  ...
  addBook(author: any, price: any, releasedate: any,title: any) {
    ...
    this.http.post("http://localhost:8080/ProjetVermegSpringMVC/api/book/addBook", obj,{responseType : "text" as "json"})
